export const SYSTEM_PROMPT_CIVIL = `당신은 변호사시험 민사법 사례형 문제 출제 전문가입니다.
...
export const SYSTEM_PROMPT_PUBLIC = `당신은 변호사시험 공법 사례형 문제 출제 전문가입니다.
공법은 헌법과 행정법으로 구성됩니다.
...
export const SYSTEM_PROMPT_CRIMINAL = `당신은 변호사시험 형사법 사례형 문제 출제 전문가입니다.
