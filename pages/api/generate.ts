...
<사실관계>
[판례의 실제 사실관계와 분쟁 경위를 충실히 재현. 등장인물 이름(甲, 乙, 丙, 丁 등)만 바꾸고 사건의 핵심 사실·경위·법률관계는 원판례 그대로 유지. 날짜·금액·부동산 종류 등 구체적 수치 포함. 변시 특유의 간결한 법률문체로 작성]
...
나. 사안의 적용
[판례의 논리 흐름을 그대로 따라 서술. 법원이 어떤 요건을 어떤 순서로 검토하여 결론에 이르렀는지 재현. 판례에서 결론의 근거가 된 구체적 사실을 특정하여 법리에 포섭]
...
## 사실관계 작성 원칙
- 판례의 실제 사실관계를 기반으로 작성할 것 — 핵심 사실·분쟁 경위·법률관계를 원판례에서 벗어나지 않게 유지하고, 인물 이름만 甲·乙 등으로 치환
- 판례의 쟁점이 자연스럽게 드러나도록 사실관계를 구성할 것

## 해설 법리 작성 원칙 (핵심 — 반드시 준수)
- **결론은 반드시 판례의 결론과 일치시킬 것** — 판례가 청구를 인용한 경우 해설의 결론도 인용, 기각한 경우 기각으로 작성. 판례와 반대되는 결론을 내리는 것은 절대 금지
- "가. 관련 판례의 법리" 항목은 입력된 판결요지 원문에 충실하게 작성할 것
- 판결요지 원문에 없는 내용을 법리로 서술해야 할 경우, 반드시 "생각건대,"라는 표현을 앞에 붙여 원문과 구별할 것
- "원칙적으로"라는 표현은 판결요지 원문에 그 표현이 직접 등장하는 경우에만 사용할 것 — 임의로 추가 금지
- "나. 사안의 적용"은 판례의 논리 흐름(요건 검토 순서, 판단 근거, 결론 도출 과정)을 그대로 따를 것 — 추상적 포섭에 그치지 말고, 판례가 결론의 근거로 삼은 구체적 사실을 명시하여 포섭
- 단, 선고일자가 1970. 1. 1. 이전인 판결은 현재의 판례 법리와 다를 수 있으므로, 위 제한을 완화하여 현행 법리를 기준으로 해설을 작성해도 무방함
...
- **결론은 반드시 판례의 결론과 일치시킬 것** — 판례가 청구 인용·위헌·취소 등의 결론을 낸 경우 해설의 결론도 그에 맞게 작성. 기각·합헌·처분 적법 등의 결론인 경우도 마찬가지. 판례와 반대되는 결론을 내리는 것은 절대 금지
...
- "나. 사안의 적용" 항목에는 판례의 논리 흐름(요건 검토 순서, 판단 근거, 결론 도출 과정)을 그대로 따라 서술할 것 — 법원이 어떤 사실을 근거로 어떤 결론을 내렸는지 원문에 가깝게 재현하고, 임의로 사실을 추가하거나 판결 이유를 변형하지 말 것
...
나. 사안의 적용
[판결문의 실제 판단 내용을 사안에 그대로 대응시켜 서술할 것. 판결문에서 법원이 인정한 구체적 사실(처분 경위, 법령 요건 충족 여부, 재량 일탈 여부, 기본권 침해 여부 등)을 판결요지 원문과 대조하면서 포섭. 법원의 최종 판단이 무엇이었는지(인용·기각·위헌·합헌 등)와 그 이유를 원문에 충실하게 재현. 임의로 사실을 추가하거나 판결 이유를 변형하지 말 것]
...
## 해설 작성 원칙 (핵심 — 반드시 준수)
- **결론은 반드시 판례의 결론과 일치시킬 것** — 판례가 유죄로 판단한 경우 해설의 결론도 유죄, 무죄로 판단한 경우 무죄로 작성. 수사의 적법성 여부(적법/위법), 증거능력 인정 여부도 판례 결론에 따를 것. 판례와 반대되는 결론을 내리는 것은 절대 금지
- "가. 관련 판례의 법리" 항목은 판결요지 원문에 충실하게 작성할 것
- 판결요지 원문에 없는 내용을 법리로 서술해야 할 경우, 반드시 "생각건대,"라는 표현을 앞에 붙여 원문과 구별할 것
- "원칙적으로"라는 표현은 판결요지 원문에 그 표현이 직접 등장하는 경우에만 사용할 것 — 임의로 추가 금지
- "나. 사안의 적용"은 판례의 논리 흐름(요건 검토 순서, 판단 근거, 결론 도출 과정)을 그대로 따를 것 — 추상적 포섭에 그치지 말고, 판례가 결론의 근거로 삼은 구체적 사실을 명시하여 포섭
