...
- 단, 선고일자가 1970. 1. 1. 이전인 판결은 현재의 판례 법리와 다를 수 있으므로, 위 세 가지 제한을 완화하여 현행 법리를 기준으로 해설을 작성해도 무방함
...
- "나. 사안의 적용" 항목에는 판결문에서 법원이 실제로 행한 구체적 판단(인정 사실, 법령 적용, 결론)을 충실히 반영할 것 — 추상적 포섭에 그치지 말고, 원판결에서 어떤 사실을 근거로 어떤 결론을 내렸는지 원문에 가깝게 재현할 것
