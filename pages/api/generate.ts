...
[문 1]
1. 결론
[핵심 결론을 명확히 — 반드시 판례의 결론과 일치. 청구 인용·기각, 권리 발생·소멸, 계약 효력 등 법적 효과를 구체적으로 명시]

2. 논거
가. 관련 판례의 법리 (대법원 XXXX. X. X. 선고 XXXXXX 판결)

(1) 관련 규정
[핵심 민법 조문 번호와 내용 요약 — 조문이 여럿인 경우 각각 명시. 예: 민법 제548조(해제의 효과), 민법 제741조(부당이득반환의무)]

(2) 판례의 법리
[판결요지 원문에 충실하게 법리 서술. 판례가 제시한 요건·효과·법률관계를 상세히 설명. 판단 기준이 여럿인 경우 각 기준별로 구체화하여 서술. 단순 요약 금지 — 판결요지의 핵심 문장은 원문 그대로 인용]

(3) 검토
[학설 대립(다수설·소수설·판례)이 있는 경우 주요 견해를 소개하고 판례 입장을 명확히 정리. 판결요지에 없는 내용을 보완할 경우 반드시 "생각건대,"로 시작. 별도 검토가 필요 없는 경우 이 항목 생략]

나. 사안의 적용
[판례가 제시한 요건을 하나씩 사안의 구체적 사실에 포섭. 요건이 복수인 경우 "(1) [요건명] ... (2) [요건명] ..." 형식으로 나누어 각각 서술. 법원이 어떤 사실을 근거로 어떤 순서로 결론에 이르렀는지 재현. 단순한 추상적 포섭 금지 — 판례가 결론의 근거로 삼은 구체적 사실(날짜·금액·행위 등)을 명시하며 각 요건별 충족 여부를 서술]
...
- "가. 관련 판례의 법리 (2) 판례의 법리" 항목은 입력된 판결요지 원문에 충실하게 작성할 것
...
- 해설 분량은 충분히 풍부하게 작성할 것 — 각 소항목이 지나치게 짧아지지 않도록 상세히 서술
...
[문 1]
1. 결론
乙의 소멸시효 완성 주장은 타당하지 않다. 甲의 임대차보증금반환채권은 시효로 소멸하지 않았으므로, 법원은 甲의 청구를 인용하여야 한다.

2. 논거
가. 관련 판례의 법리 (대법원 2020. 7. 9. 선고 2016다244224 판결)

(1) 관련 규정
민법 제166조 제1항은 소멸시효는 권리를 행사할 수 있는 때로부터 진행한다고 규정한다. 민법 제536조는 쌍무계약에서 일방이 상대방의 이행 제공 전에 자기 채무의 이행을 거절할 수 있는 동시이행항변권을 규정하며, 임대차 종료 시 임차인의 목적물반환의무와 임대인의 보증금반환의무는 이 동시이행관계에 놓인다.

(2) 판례의 법리
임대차가 종료함에 따라 발생한 임차인의 목적물반환의무와 임대인의 보증금반환의무는 동시이행관계에 있다. 임차인이 임대차 종료 후 동시이행항변권을 근거로 임차목적물을 계속 점유하는 것은 보증금반환채권에 기초한 권능을 행사한 것으로서, 보증금을 반환받으려는 계속적인 권리행사의 모습이 분명하게 표시되었다고 볼 수 있다. 따라서 이러한 경우 보증금반환채권의 소멸시효는 진행하지 않는다.

나. 사안의 적용
(1) 동시이행관계의 성립
甲과 乙 사이의 임대차계약은 2000. 5. 30. 기간 만료로 종료되었고, 이로써 甲의 목적물반환의무와 乙의 보증금반환의무는 동시이행관계에 놓이게 되었다.

(2) 권리행사 여부
甲은 임대차 종료 후 乙의 인도 요구에 대하여 동시이행항변권을 근거로 X 주택의 인도를 거부하고 계속 점유하였는바, 이는 보증금반환채권에 기초한 권능을 행사한 것으로서 계속적인 권리행사의 모습이 분명하게 표시된 경우에 해당한다.

(3) 소멸시효 진행 여부
따라서 甲이 X 주택을 점유하는 동안에는 보증금반환채권의 소멸시효가 진행하지 않으며, 乙의 소멸시효 완성 항변은 이유 없다.
...
[문 1]
1. 결론
[핵심 결론을 명확히 — 반드시 판례의 결론과 일치. 인용·기각·위헌·합헌·취소·적법 등 법적 효과를 구체적으로 명시]

2. 논거
가. 관련 판례의 법리 (대법원/헌법재판소 XXXX. X. X. 선고 XXXXXX 판결/결정)

(1) 관련 규정
[핵심 헌법·행정법 조문 번호와 내용 요약 — 조문이 여럿인 경우 각각 명시. 예: 헌법 제37조 제2항(기본권 제한의 한계), 행정소송법 제12조(원고적격), 행정기본법 제15조(처분의 효력)]

(2) 판례의 법리
[판결요지 원문의 핵심 법리 문장을 그대로 인용. 판단 기준·요건·고려 요소를 빠짐없이 서술. 기준이 여럿인 경우 각 기준별로 구체화. 단순 요약 금지 — 원문 문장 그대로 인용]

(3) 검토
[학설 대립(다수설·소수설·판례)이 있는 경우 주요 견해를 소개하고 판례 입장을 명확히 정리. 판결요지에 없는 내용을 보완할 경우 반드시 "생각건대,"로 시작. 별도 검토가 필요 없는 경우 이 항목 생략]

나. 사안의 적용
[판례가 제시한 요건·기준을 하나씩 사안의 구체적 사실에 포섭. 요건이 복수인 경우 "(1) [요건명] ... (2) [요건명] ..." 형식으로 나누어 각각 서술. 법원이 인정한 구체적 사실(처분 경위, 법령 요건 충족 여부, 재량 일탈 여부, 기본권 침해 여부 등)을 판결요지 원문과 대조하면서 포섭. 법원의 최종 판단(인용·기각·위헌·합헌 등)과 그 이유를 원문에 충실하게 재현. 임의로 사실을 추가하거나 판결 이유를 변형하지 말 것]
...
- 모델 판례 원문은 입력된 판결요지에서 그대로 발췌 (재작성 금지)
- 해설 분량은 충분히 풍부하게 작성할 것 — 각 소항목이 지나치게 짧아지지 않도록 상세히 서술
- 학설 대립이 있는 경우 주요 견해를 소개하고 판례의 입장을 명확히 정리할 것`;
...
[문 1]
1. 결론
[핵심 결론을 명확히 — 반드시 판례의 결론과 일치. 유죄·무죄, 수사 적법·위법, 증거능력 인정·부정 등 법적 효과를 구체적으로 명시]

2. 논거
가. 관련 판례의 법리 (대법원 XXXX. X. X. 선고 XXXXXX 판결)

(1) 관련 규정
[핵심 형법·형사소송법 조문 번호와 내용 요약 — 조문이 여럿인 경우 각각 명시. 예: 형법 제30조(공동정범), 형사소송법 제308조의2(위법수집증거 배제법칙)]

(2) 판례의 법리
[판결요지 원문에 충실하게 법리 서술. 판례가 제시한 요건·효과를 상세히 설명. 판단 기준이 여럿인 경우 각 기준별로 구체화하여 서술. 단순 요약 금지 — 판결요지의 핵심 문장은 원문 그대로 인용]

(3) 검토
[학설 대립(다수설·소수설·판례)이 있는 경우 주요 견해를 소개하고 판례 입장을 명확히 정리. 판결요지에 없는 내용을 보완할 경우 반드시 "생각건대,"로 시작. 별도 검토가 필요 없는 경우 이 항목 생략]

나. 사안의 적용
[판례가 제시한 요건을 하나씩 사안의 구체적 사실에 포섭. 요건이 복수인 경우 "(1) [요건명] ... (2) [요건명] ..." 형식으로 나누어 각각 서술. 법원이 어떤 요건을 어떤 순서로 검토하여 결론에 이르렀는지 재현. 단순한 추상적 포섭 금지 — 판례가 결론의 근거로 삼은 구체적 사실(범행 일시·방법·결과·수사 경위 등)을 명시하며 각 요건별 충족 여부를 서술]
...
- "가. 관련 판례의 법리 (2) 판례의 법리" 항목은 판결요지 원문에 충실하게 작성할 것
- 판결요지 원문에 없는 내용을 법리로 서술해야 할 경우, 반드시 "생각건대,"라는 표현을 앞에 붙여 원문과 구별할 것
- "원칙적으로"라는 표현은 판결요지 원문에 그 표현이 직접 등장하는 경우에만 사용할 것 — 임의로 추가 금지
- "나. 사안의 적용"은 판례의 논리 흐름(요건 검토 순서, 판단 근거, 결론 도출 과정)을 그대로 따를 것 — 추상적 포섭에 그치지 말고, 판례가 결론의 근거로 삼은 구체적 사실을 명시하여 포섭
...
- 모델 판례 원문은 입력된 판결요지에서 그대로 발췌 (재작성 금지)
- 해설 분량은 충분히 풍부하게 작성할 것 — 각 소항목이 지나치게 짧아지지 않도록 상세히 서술
- 학설 대립(다수설·소수설·판례 등)이 있는 경우 주요 견해를 소개하고 판례의 입장을 명확히 정리할 것`;
